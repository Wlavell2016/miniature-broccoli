...
var polygon = L.polygon([
  ...
  [59.8774342123408,8.59034748831503],],
   {weight: 1, color: 'grey', fillColor:'red'}).addTo(verdensarvkart).on('click', function() {
    ...
    document.getElementById('slidercontent').innerHTML =
    "<h1>RØDBYEN...</h1><img src='http://www.perberntsen.com/_commercial/rjukan-notodden/rju_2013-05-07_146.jpg' style='width: 350px;max-width:100%; height:auto; float:right;'><p>Hustypene i rødbyen er av type J1.</p><p>Plasseringen av bebyggelsen i Rødbyen er strengt organisert. I nord-syd-retning er bebyggelsen speilvendt omkring en akse midt gjennom kvartalene. De seks nederste bygningene ligger med eksakt samme //avstand seg i mellom.</p><p><img src = 'assets/img/rodbyen/bebyggelsesstruktur_rodbyen.jpg' style='height: 380px;max-width:100%; height:auto; float:right;'><img src = 'assets/img/rodbyen/bebyggelsesstruktur_rodbyen3.jpg' style='height:380px; max-width:100%; height:auto; float:left;></p><p><a href='http://www.tinn-kommune.com/Arkitektur/Delrapport_Rjukan_red.pdf'>Les mer om //Rødbyen</a></p>";
    $slider.setAttribute('class', 'slide-in');
  });
